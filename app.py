...
model_id = st.sidebar.selectbox("Select LLM Model", ["anthropic.claude-3-haiku-20240307-v1:0", "anthropic.claude-3-5-sonnet-20240620-v1:0", "mistral.mistral-small-2402-v1:0", "ai21.j2-ultra", "amazon.titan-text-express-v1"])
kb_id = st.sidebar.text_input("Knowledge Base ID", "VBXA2WLB85")
